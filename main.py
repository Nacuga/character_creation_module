...
def start_training(character):
    ...
    while cmd != 'skip':
        ...
        if cmd in command.char_name:
            print(command.attack(command.char_name, command.char_class))
...
def choice_char_class():
    ...
    while approve_choice != 'y':
        char_class = input('Для выбора класса персонажа введите его '
        ...
        approve_choice = input('Подтвердите (Y) или '
                               'повторите (any key) выбор ').lower()
    return char_class
